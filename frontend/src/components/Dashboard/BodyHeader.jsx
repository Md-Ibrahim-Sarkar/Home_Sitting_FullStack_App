          ...
          <div className='flex items-center gap-y-6 max-sm:flex-col z-50 w-full pb-2'>
            ...
            <div className="flex items-center justify-end gap-6 ml-auto">
              <div className='flex items-center space-x-6'>
                ...
                <div
                  className="w-9 h-[38px] flex items-center justify-center rounded-xl relative bgRed-200 cursor-pointer">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-[18px] h-[18px] fillRed-600" viewBox="0 0 24 24">
                    <path
