  ...
  return (
    <>
      <div className="font-sans py-4 mx-auto lg:max-w-6xl md:max-w-4xl max-w-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 sm:gap-6 gap-4">

          {services ? services?.slice(0, 8).map(service => <Link to={`/services/details/${service._id}`} onClick={handleClick} key={service._id} className="bg-gray-100 p-3 rounded-lg group overflow-hidden cursor-pointer relative z-20 hover:before:bg-black before:absolute before:inset-0 before:opacity-20 before:transition-all">
            ...
            <div className="absolute mx-auto left-0 right-0 bottom-2 lg:-bottom-80 lg:group-hover:bottom-2 bg-black/60 lg:bg-white w-11/12 p-2 lg:p-3 rounded-lg transition-all duration-300">
              <div className="text-center">
                ...
                <h4 className="text-sm lg:text-base text-blue-600 font-bold mt-2">$35.00</h4>
              </div>
