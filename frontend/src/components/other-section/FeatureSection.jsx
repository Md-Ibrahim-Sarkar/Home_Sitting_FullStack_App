...
const FeatureSection = () => {
  return (
    <>
      <div className="max-w-6xl mx-auto font-[sans-serif] py-10">
        <h2 className=" sm:text-4xl text-2xl font-extrabold  text-center mb-16">Discover Our Exclusive Features</h2>
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-12">
          <div className="text-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="#00ffff" className="w-8 mb-6 inline-block" viewBox="0 0 32 32">
            ...
            <p className=" text-sm">Get professional home services tailored to your needs. From cleaning to repairs, we've got you covered.</p>
          </div>

          <div className="text-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="#00ffff" className="w-8 mb-6 inline-block" viewBox="0 0 682.667 682.667">
              <defs>
                <clipPath id="a" clipPathUnits="userSpaceOnUse">
                  <path d="M0 512h512V0H0Z" data-original="#000000" />
                </clipPath>
              </defs>
              <g fill="none" stroke="#00ffff" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="40" clipPath="url(#a)" transform="matrix(1.33 0 0 -1.33 0 682.667)">
            ...
            <p className=" text-sm">Keep your home safe with trusted security solutions. Enjoy peace of mind with our reliable protection.</p>
          </div>

          <div className="text-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="#00ffff" className="w-8 mb-6 inline-block" viewBox="0 0 512.001 512.001">
            ...
            <p className=" text-sm">Get 24/7 assistance for all your home service needs. We're here to help anytime, anywhere.</p>
          </div>

          <div className="text-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="#00ffff" className="w-8 mb-6 inline-block" viewBox="0 0 24 24">
            ...
            <p className=" text-sm">Enjoy fast and reliable home services, ensuring top-notch performance every time.</p>
          </div>

          <div className="text-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="#00ffff" className="w-8 mb-6 inline-block" viewBox="0 0 504.69 504.69">
            ...
            <p className=" text-sm">Access trusted home services wherever you are, with our extensive network of professionals.</p>
          </div>
          ...
          <div className="text-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="#00ffff" className="w-8 mb-6 inline-block" viewBox="0 0 682.667 682.667">
              ...
              <g fill="none" stroke="#00ffff" strokeMiterlimit="10" strokeWidth="30" clipPath="url(#a)" transform="matrix(1.33 0 0 -1.33 0 682.667)">
            ...
            <p className=" text-sm">Stay connected with our smooth and efficient communication for all your home service needs.</p>
          </div>
        </div>
      </div>
    </>
