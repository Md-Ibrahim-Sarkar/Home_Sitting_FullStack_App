...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  ...
  return (
    <>
      {/* Mobile Overlay */}
      {isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-[90] lg:hidden" onClick={toggleSidebar} />
      )}

      {/* Sidebar */}
      <nav
        id="sidebar"
        className={`fixed lg:relative lg:w-[270px] w-[270px] h-screen bg-gray-900 shrink-0 z-[100] transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'
          }`}
      >
