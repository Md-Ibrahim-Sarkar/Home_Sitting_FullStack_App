...
function ProductList() {
  ...
  return (
    <div className="max-w-[1300px] mx-auto p-1 relative mt-0">
      <ScrollToTop />
      <div className="flex gap-4">
        <LeftSidebar toggleDropdown={toggleDropdown} price={price} setPrice={setPrice} openDropdown={openDropdown} setOpenDropdown={setOpenDropdown} showSidebar={showSidebar} setShowSidebar={setShowSidebar} mainProducts={mainProducts} setMainProducts={setMainProducts} />

        <RightSidebar sortOption={sortOption} handleSortChange={handleSortChange} getSortedProducts={getSortedProducts} handleAddToCart={handleAddToCart} />
      </div>
    </div>
  );
}
