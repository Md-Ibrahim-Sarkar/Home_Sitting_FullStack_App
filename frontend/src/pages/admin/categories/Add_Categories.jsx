    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-6">
      <div className="bg-white rounded-xl shadow-lg p-8">
        <div className="flex items-center justify-center mb-8">
          <FaList className="text-3xl text-teal-500 mr-3" />
        ...
        <form onSubmit={handleAddCategory} className="mb-8">
          <div className="bg-gray-50 p-6 rounded-lg border border-gray-100">
            <h3 className="text-lg font-semibold text-gray-700 mb-4 flex items-center">
              <FaPlus className="text-teal-500 mr-2" />
              Add New Category
            </h3>
            <div className="space-y-4">
              ...
              <button
                className="w-full bg-teal-500 hover:bg-teal-600 text-white px-6 py-3 rounded-lg active:scale-95 transition-all duration-200 flex items-center justify-center gap-2"
                type="submit"
              >
                <FaPlus />
                Add Category
