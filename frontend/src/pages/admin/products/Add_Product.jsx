...
export default function AddProduct() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 max-[640px]:p-0">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 max-[640px]:p-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-gray-50 dark:bg-gray-700 p-6  max-[640px]:p-2 rounded-xl">
            ...
            <textarea
              className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent h-32"
              name="description"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <UploadImage
                    ...
                    multiple={true}
                    folder="products"
                    onUploadStart={() => toast.info("Starting image upload...")}
