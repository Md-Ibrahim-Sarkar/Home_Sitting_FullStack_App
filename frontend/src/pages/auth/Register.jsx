...
const Register = () => {
  ...
  return (
    <>
      <div className="font-[sans-serif] bg-white dark:bg-gray-900 md:h-screen max-w-[1300px] mx-auto">
        <div className="grid md:grid-cols-2 items-center gap-8 h-full">
          ...
          <div className="flex items-center md:p-2 p-3 pt-1 bg-white dark:bg-gray-900  h-full lg:w-11/12 lg:ml-auto">
            <form className="max-w-lg w-full mx-auto" onSubmit={submitHandle}>
              ...
              <div className="mt-8">
                <div>
                  <button type="submit" className="w-max cursor-pointer hover:scale-110 active:scale-100 duration-300 shadow-xl py-3 px-6 text-sm text-gray-800 font-semibold rounded  bg-cyan-500 hover:bg-cytext-cyan-500 focus:outline-none">
                    Register
                  </button>
